...
class TestUserFlow:
    ...
    def test_full_signup_and_login_flow(self, client, db_session, sample_major, sample_interest, sample_allowed_domain, sample_user):
        """
    ...
    def test_create_major_and_assign_to_user(self, client, db_session, sample_allowed_domain):
