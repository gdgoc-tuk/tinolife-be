...
class TestAuthAPI:
    ...
    def test_check_email_domain_not_allowed(self, client):
        ...
        response = client.post(
            "/auth/check-domain",
            json={"email": "student@notallowed.com"}
        )
    ...
    def test_create_allowed_domain(self, client):
        ...
        response = client.post(
            ...
            json={
                "domain": "@newuniv.ac.kr",
                "university_name": "신규대학교"
            }
        )
