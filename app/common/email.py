...
class EmailService:
    ...
    def send_verification_code(
        self, to_email: str, code: str, expires_minutes: int = 5
    ) -> bool:
        """
        인증 코드 이메일을 전송합니다.
        ...
        <head>
            ...
            <style>
                body {{
                    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  # noqa: E501
                    line-height: 1.6;
                    color: #333;
                ...
                .header {{
                    background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);  # noqa: E501
                    color: white;
                    padding: 30px;
                    text-align: center;
                }}
        ...
        <body>
            <div class="container">
                ...
                <div class="footer">
                    ...
                    <p>문의사항이 있으신가요? <a href="mailto:tinolifeofficial@gmail.com">tinolifeofficial@gmail.com</a></p>  # noqa: E501
                </div>
            </div>
        </body>
        </html>
